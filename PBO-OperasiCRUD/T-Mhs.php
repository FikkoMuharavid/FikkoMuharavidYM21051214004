  ...
  <body>
    ...
    <div class="container">
        ...
        <table class="table table-bordered table-hover" width="50%">
            ...
            ?>
            <tbody>
                <td><center><?php echo $hasil['id_mhs'] ?></td></center>
                <td align="center"><?php echo $hasil['nim'] ?></td>
                ...
                <td align="center">
                    <a class="btn btn-success" href="edit-T-Mhs.php?nim=<?php echo $hasil['nim'] ?>">Edit</a>
                    <a class="btn btn-danger" href="delete-T-Mhs.php?nim=<?php echo $hasil['nim'] ?>">Hapus</a>
                </td>
                <?php } ?>
            </tbody>
        </table>
