  ...
  <body>
    ...
    <div class="container">
        ...
        <table class="table table-bordered" width="50%">
            ...
            ?>
            <tbody>
                <td align="center"><?php echo $hasil['id_jk'] ?></td>
                <td><?php echo $hasil['nama'] ?></td>
                <td align="center">
                    <a class="btn btn-success" href="edit-T-JK.php?id_jk=<?php echo $hasil['id_jk'] ?>">Edit</a>
                    <a class="btn btn-danger" href="delete-T-JK.php?id_jk=<?php echo $hasil['id_jk'] ?>">Hapus</a>
                </td>
                <?php } ?>
            </tbody>
        </table>
