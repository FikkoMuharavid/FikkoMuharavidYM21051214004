  ...
  <body>
    ...
    <div class="container">
        ...
        <table class="table table-bordered" width="50%">
            ...
            ?>
            <tbody>
                <td align="center"><?php echo $hasil['id_prodi'] ?></td>
                <td><?php echo $hasil['jenjang'] ?></td>
                <td><?php echo $hasil['nama_prodi'] ?></td>
                <td align="center">
                    <a class="btn btn-success" href="edit-T-Prodi.php?id_prodi=<?php echo $hasil['id_prodi'] ?>">Edit</a>
                    <a class="btn btn-danger" href="delete-T-Prodi.php?id_prodi=<?php echo $hasil['id_prodi'] ?>">Hapus</a>
                </td>
                <?php } ?>
            </tbody>
        </table>
